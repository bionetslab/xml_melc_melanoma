...
antibody_gene_symbols = {
    ...
    "S100-FITC": "S100",
    'SOX10-FITC': 'SOX10',
    'Mouse IgG1-FITC': 'Mouse IgG1',  # Placeholder symbol for generic mouse IgG1
    'CHD1-FITC': 'CHD1',
    'Flt4-AF488': 'FLT4',
    'TIMP1-FITC': 'TIMP1',
    'Vav-FITC': 'VAV1',  # Assuming Vav refers to VAV1, but there are other Vav family members
    'TIMP1': 'TIMP1',
    'Vav': 'VAV',  # Assuming Vav refers to VAV1, but there are other Vav family members
    'anti-Goat IgG-AF488': 'anti-Goat IgG',  # Placeholder symbol for generic goat IgG
    'anti-Rabbit IgG-AF488': 'anti-Rabbit IgG',  # Placeholder symbol for generic rabbit IgG
    'p21-FITC': 'CDKN1A'  # p21 is also known as CDKN1A
}
...
for segment in ["nuclei", "cell"]:
    ...
    for i, fov in enumerate(tqdm(seg.fields_of_view)):
        ...
        for antibody in exp_fov.columns:
            try:
                antibody_gene_symbols[antibody] 
            except:
                print(antibody)
